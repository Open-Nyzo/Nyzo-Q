...
TESTS = ("ee0ca66b98f98bb4da96efc526c2aaa0c4de317f8e23dd5b0cba2b765e45ba86",
         "0366d56dfba7223fe92b1d24448128db8a84a309d4a4d2eeaf474810387f5ef0",
         "ece4279b1b6f9d14f324a2c6c650bd568d4fdf35e259859585786c2f7c1b106c",
         "f547ae6254c56b23b6b96515a6b9d4d04003878e6aace550a7f57ce8d3c5c3f1",
         "e5e6d895e3e27ae0224b7fc20902e184841748b40a912666e2794988f79bb53e")
...
if __name__ == "__main__":
    ...
    for cycle_hash in TESTS:
        print("Hash", cycle_hash, socket.inet_ntoa(bytes.fromhex(cycle_hash)[:4]))
        for i in range(5):
            winner = readers[i].winner(bytes.fromhex(cycle_hash), scoring=linear_ip_score)
